        ...
        if(user.enabled && user.role.localeCompare("Invitado") == 0) {
            ...
            try {
                ...
                await this.mailerService.sendMail({
                    ...
                    html: `<!DOCTYPE HTML><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'></head><body style='background-color: ghostwhite !important; font-family: sans-serif; min-height: 100vh; margin: 0px !important;'><div style='max-width: 600px;'><div style='display: flex; margin-bottom: 1.5rem!important; padding-right: .75rem; padding-left: .75rem;'><div style='position: relative; margin-right: 20px; min-width: 0; word-wrap: break-word; background-color: #fff; background-clip: border-box; border: 1px solid rgba(0,0,0,.125); border-radius: 0.25rem; width: 50%;'><div style='flex: 1 1 auto; padding: 1rem 1rem;'><div style='display: flex; margin: auto; align-items: center; margin-bottom: 15px;'><div style='display: flex; align-items: center;'><img style='width: 39px; height: 39px; padding: 25px 10px 0px 0px;' alt='CreditCard' src='https://webapps.metrogas.com.ar/firma/MGAS_Mailing_Credit_Card.png'></div><div><p style='font-size: 18px; color: #0072bc !important; font-weight: 700;'>Pagá tu<br>saldo online</p></div></div><div style='text-align: center;'><a href='%SAP_ZNOTIF_CONTEXTO_ATRIBUTOS-LINK2' style='display: inline-block; font-weight: 400; line-height: 1.5; color: #fff; text-align: center; text-decoration: none; vertical-align: middle; cursor: pointer; border-color: #0d6efd; user-select: none; border: 1px solid transparent; padding: 0.375rem 0.75rem; font-size: 1rem; border-radius: 0.25rem; background-color: #0072bc !important; width: 150px; height: 30px;'>Pagar</a></div></div></div><div style='position: relative; display: flex; flex-direction: column; min-width: 0; word-wrap: break-word; background-color: #fff; background-clip: border-box; border: 1px solid rgba(0,0,0,.125); border-radius: 0.25rem; width: 50%;'><div style='flex: 1 1 auto; padding: 1rem 1rem;'><div style='display: flex; margin: auto; align-items: center; margin-bottom: 15px;'><div style='display: flex; align-items: center;'><img style='width: 39px; height: 39px; padding: 25px 10px 0px 0px;' alt='Calendar' src='https://webapps.metrogas.com.ar/firma/MGAS_Mailing_Calendar.png'></div><div><p style='font-size: 18px; color: #0072bc !important; font-weight: 700;'>Fecha de<br>vencimiento</p></div></div><div style='font-size: 1.3rem; font-weight: 400; line-height: 1.5; text-align: center'><input id='%SAP_ZNOTIF_CONTEXTO_ATRIBUTOS-FECHA_VENCIMIENTO' dir='ltr' value='Fecha de vencimiento' style='font-size: 1.3rem; display: block; border: 0; width: 100%; font-weight: 400; line-height: 1.5; color: #212529; text-align: center; background-clip: padding-box; appearance: none; transition: border-color .15s ease-in-out,box-shadow .15s ease-in-out;'></div></div></div></div></div></body>`
                });
            } catch (error) {
                throw new ServiceUnavailableException(error);
            }
